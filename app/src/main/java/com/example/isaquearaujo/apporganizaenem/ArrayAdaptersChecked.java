...
public class ArrayAdaptersChecked extends BaseAdapter
{
    ...
    public  ArrayAdaptersChecked(Activity c, ArrayList<String> AL_name_time,ArrayList<String> AL_name_time2,
